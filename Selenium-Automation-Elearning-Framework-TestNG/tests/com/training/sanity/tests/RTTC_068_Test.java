...
public class RTTC_068_Test {
	...
	public void productlinkTest(String userName,String password,String productnameedit,String ManagetitleEdit,String modeltexbox,String modelpricetexbox,String modelQuanitytexbox) throws InterruptedException {
		...
		String Actstatus= rttc068POM.saveSuccessMsg();
		String Expstatus=  "Success: You have" ;
		
		Assert.assertTrue(Actstatus.contains(Expstatus));
		System.out.println("Saved Status is displayed sucessfully------->" +Expstatus  + Actstatus);
